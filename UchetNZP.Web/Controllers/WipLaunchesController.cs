...
public class WipLaunchesController : Controller
{
    ...
    public async Task<IActionResult> CreateMetalRequirement(Guid id, Guid? manualMaterialId, CancellationToken cancellationToken)
    {
        ...
        foreach (var norm in norms)
        {
            ...
            {
                TempData["LaunchMetalRequirementError"] = selection.Reason;
                return RedirectToAction(nameof(History));
            }
            ...
            requirementItems.Add(new MetalRequirementItem
            {
                ...
                TotalRequiredWeightKg = CalculateTotalWeightKg(norm.BaseConsumptionQty * launch.Quantity, norm.ConsumptionUnit, selection.Material.WeightPerUnitKg, selection.Material.Coefficient),
