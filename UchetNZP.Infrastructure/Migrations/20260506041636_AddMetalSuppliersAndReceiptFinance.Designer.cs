...
namespace UchetNZP.Infrastructure.Migrations
{
    ...
    [Migration("20260506041636_AddMetalSuppliersAndReceiptFinance")]
    partial class AddMetalSuppliersAndReceiptFinance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UchetNZP.Domain.Entities.MetalReceipt", b =>
                {
                    ...
                    b.Property<Guid?>("MetalSupplierId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SupplierIdentifierSnapshot")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");

                    b.Property<string>("SupplierInnSnapshot")
                        .HasMaxLength(12)
            ...
            modelBuilder.Entity("UchetNZP.Domain.Entities.MetalSupplier", b =>
                {
                    ...
                    b.ToTable("MetalSuppliers", (string)null);
                });
            ...
            modelBuilder.Entity("UchetNZP.Domain.Entities.SystemParameter", b =>
                {
            ...
            modelBuilder.Entity("UchetNZP.Domain.Entities.MetalReceipt", b =>
                {
                    b.HasOne("UchetNZP.Domain.Entities.MetalSupplier", "MetalSupplier")
                        .WithMany("Receipts")
                        .HasForeignKey("MetalSupplierId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("MetalSupplier");
                });
